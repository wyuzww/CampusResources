...
<head>
    ...
    <script type="text/javascript">
        ...
        function openAddTeacherDialog() {
            ...
            resetValue();
            url = "admin/admin_addTeacher.action";
        }
...
<body>
<table id="dg" title="管理教师帐号" class="easyui-datagrid"
       data-options="url:'admin/admin_allTeacher.action',pagination:true,rownumbers:true,fitColumns:true, fit:true " toolbar="#tb" >
    <thead>
    <tr>
        <th field="cb" checkbox="true"></th>
        <th field="user_id" width="100" align="center">帐号</th>
        <th field="user_password" width="100" align="center">密码</th>
        <th field="teacher_name" width="100" align="center"  data-options="formatter:function(value,rec){return rec.user_teacher.teacher_name}">姓名</th>
        <th field="teacher_sex" width="50" align="center"data-options="formatter:function(value,rec){return rec.user_teacher.teacher_sex}">性别</th>
        <th field="teacher_birth" width="100" align="center" data-options="formatter:function(value,rec){return rec.user_teacher.teacher_birth}">生日</th>
        <th field="teacher_desc" width="150" align="center" data-options="formatter:function(value,rec){return rec.user_teacher.teacher_desc}">个人说明</th>
...
<div id="dlg" class="easyui-dialog" style="width: 370px;height: 250px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="5px;">
            ...
            <tr>
                <td>姓名：</td>
                <td><input type="text" name="user_teacher.teacher_name" id="teacher_name" class="easyui-validatebox" required="true"/></td>
            </tr>
        </table>
    </form>
</div>
