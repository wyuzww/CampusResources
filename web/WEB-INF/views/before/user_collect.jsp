    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="clearfix">
                ...
                <li style="display:block">
                    <a class="list-group-item active" title="我的收藏" href="user/user_myCollect.action">我的收藏</a>
                </li>
            </ul>
        </div>
            ...
            <div class="panel panel-default ">
                <div class="container-fluid">
                    <div style="margin: 20px">
                        <form class=" form-inline" action="user/user_myCollect.action" method="POST" id="form-search">
                                    ...
                                    <a href="javascript:goGet('user/res_detail.action', {'rid':'${all_resource.resource_id}'})" title="${all_resource.resource_name}" class="list-group-item">
                                        <h4 class="list-group-item-heading">${all_resource.resource_name}
                                            ...
                                            <div class="navbar-right" style="margin-right: 10px">
                                                <button title="取消收藏" class="btn btn-danger btn-sm" onclick="delCollect(${all_resource.resource_id});return false;" >取消收藏
                                                </button>
                                            </div>
                                        </h4>
...
<script type="text/javascript">
    ...
    function delCollect(rid) {
        $.ajax({
            async:true,
            type:'POST',
            url:'user/res_delCollect.action',
            data:{'rid':rid},
            dataType:'json',
            success:function (data) {
                window.location.href(goPost("user/user_myCollect.action",{'code':data.code}));
            },
            error:function () {
                alert("操作失败！");
