    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="clearfix">
                ...
                <li style="display:block">
                    <a class="list-group-item" title="他的帖子" href="user/user_personPost.action?uid=${user_id}">他的帖子</a>
                </li>
            </ul>
        </div>
            ...
            <div class="panel panel-default ">
                <div class="container-fluid">
                    <div style="margin: 20px">
                        <form class=" form-inline" action="user/user_personRes.action?uid=${user_id}" method="POST" id="form-search">
